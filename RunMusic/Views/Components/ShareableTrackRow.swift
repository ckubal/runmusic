...
struct ShareableTrackRow: View {
    ...
    var body: some View {
        ...
        .cornerRadius(0) // Hard corners for clean design
    }
...
#Preview {
    ...
    return VStack(spacing: 8) {
        ShareableTrackRow(track: sampleTrack, index: 1, fontFamily: FontFamily.default, isPowerSong: true)
        ShareableTrackRow(track: sampleTrack, index: 2, fontFamily: FontFamily.default, isPowerSong: false)
        ShareableTrackRow(track: sampleTrack, index: 3, fontFamily: FontFamily.default, isPowerSong: false)
    }
    .padding()
